...
- fix(schema): correct namespaced field type from string to boolean by [@dipakparmar](https://github.com/dipakparmar) in [#3911](https://github.com/SFDO-Tooling/CumulusCI/pull/3911)
- Issue-3938 rest_deploy should throw errors just like SOAP deploy does by [@yippie](https://github.com/yippie) in [#3940](https://github.com/SFDO-Tooling/CumulusCI/pull/3940)
- Fix empty `layoutAssignments` by [@naicigam](https://github.com/naicigam) in [#3925](https://github.com/SFDO-Tooling/CumulusCI/pull/3925)
- docs: fix subject-verb agreement in deploy.md by [@sf-sesh-mannepalli](https://github.com/sf-sesh-mannepalli) in [#3999](https://github.com/SFDO-Tooling/CumulusCI/pull/3999)
- Fix Handle SF CLI 2.136+ credential redaction in SFDX org config by [@sf-brahm-gaur](https://github.com/sf-brahm-gaur) in [#4009](https://github.com/SFDO-Tooling/CumulusCI/pull/4009)

## New Contributors

- @dipakparmar made their first contribution in [#3911](https://github.com/SFDO-Tooling/CumulusCI/pull/3911)
- @sf-sesh-mannepalli made their first contribution in [#3999](https://github.com/SFDO-Tooling/CumulusCI/pull/3999)
- @sf-brahm-gaur made their first contribution in [#4009](https://github.com/SFDO-Tooling/CumulusCI/pull/4009)

**Full Changelog**: https://github.com/SFDO-Tooling/CumulusCI/compare/v4.10.0...v4.10.1
